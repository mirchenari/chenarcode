      ...
      <section>
        <div className="grid grid-cols-1 justify-items-center lg:grid-cols-2 xl:grid-cols-3">
          {portfolio.map((item, index) => (
            <div
              key={index}
              className="w-[337px] h-[200px] mb-10 rounded-lg bg-whit grid grid-cols-5 grid-rows-4 bg-white pb-5 mini-shadow hover:scale-110"
            >
              <div className="relative rounded-lg overflow-hidden row-span-3 col-span-5">
                <Image
                  alt={item.name}
              ...
              <div className="justify-self-center self-center mt-5">
                <a
                  href={item.link}
                  className="portfolio-link w-10 h-10 flex items-center justify-center bg-gray-200 rounded-md hover:bg-primary"
                  target="_blank"
                >
